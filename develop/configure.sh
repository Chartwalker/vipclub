...
TSC_PRJG_LEVEL="7"
# reset milestones of the beginnung of the year to 1 and the last year to 0
TSC_PRJG_YMS="9"
# reset milestones relases at any new milestone to 1 if there are no compiling errors and 0 if not
TSC_PRJG_YMS_R="1"
...
tsc_write_env(){
	...
	$TSC_SBP_ECHOE "\n"$2" TSC Level (var's) and milestone an release of the actual year (fun's and doc's)" >> $5

	$TSC_SBP_ECHOE "\n"$1"TSC_PRJG_LEVEL$4"$TSC_PRJG_LEVEL >> $5 >> $5
	$TSC_SBP_ECHOE $1"TSC_PRJG_YMS$4"$TSC_PRJG_YMS >> $5 >> $5
	$TSC_SBP_ECHOE $1"TSC_PRJG_YMS_R$4"$TSC_PRJG_YMS_R >> $5 >> $5

	$TSC_SBP_ECHOE "\n"$2" projekt global settings - name of the game :-) as strings" >> $5

	$TSC_SBP_ECHOE "\n"$1"TSC_PRJG_PSUMS$4"$TSC_PRJG_PSUMS >> $5 >> $5
